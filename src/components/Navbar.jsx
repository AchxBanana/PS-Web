...
export default function Navbar() {
  ...
  const stickNavbar = () => {
    if (window !== undefined) {
      ...
      if (windowHeight > 1) {
        setStickyClass(
          "fixed top-0 left-0 z-50 transition duration-500 ease-in-out",
        );
      } else {
      ...
      <nav className="p-2 bg-zinc-300 font-inter font-semibold">
        <div className="mx-auto flex flex-wrap items-center justify-between">
          ...
          <ul className="flex p-2 mt-2 gap-2 flex-col md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <li>
              <a
                className="rounded-md p-2 font-ibm_thai  hover:text-slate-600 transition duration-300 font-medium"
                href="#"
              >
                เกี่ยวกับสถานศึกษา
              </a>
            ...
            <li>
              <a
                className="rounded-md p-2 font-ibm_thai font-bold hover:text-slate-600 transition duration-300"
                href="#course"
              >
                หลักสูตร
              </a>
            ...
            <li>
              <a
                className="rounded-md p-2 hover:text-slate-600 transition duration-300"
                href="#contact"
              >
                Contacts
              </a>
            ...
            <li className="">
              <div className="dropdown inline-block relative font-inter">
                <button className="font-semibold rounded inline-flex items-center">
                  <span className="mr-1 hover:text-slate-600 transition duration-300">
                    Services System
                  </span>
                  <svg
